/*****************************************************************
	Name:					data2datastep
	Purpose:			Convert data to data step for easy sharing
	Parameters:		dsn,lib,outlib,file,obs,fmt,lbl
				
	Create Date:	Saved February 10, 2021
	Creator:			https://blogs.sas.com/content/sastraining/2016/03/11/jedi-sas-tricks-data-to-data-step-macro/
	
	Example:			%data2datastep(cars,sashelp,,5)
	Notes:				%data2datastep(!help) - will get you syntax help in the SAS log
******************************************************************/
