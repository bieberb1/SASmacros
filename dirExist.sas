/******************************************************************************************************
	Name:			dirExist
	Purpose:		Test if directory exists. Returns value 1 or 0.
					 1 - Directory exists
					 0 - Directory does not exist
	Parameters:		path - Name of directory to test for existance
	Create Date:	July 8, 2022 (saved from GitHub)
	Creator:		https://github.com/sasutils/macros
	
	Example:		%dirExist(&path.\FakeFolder);
	Notes:			
********************************************************************************************************/
